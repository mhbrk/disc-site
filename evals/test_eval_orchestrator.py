...
from breba_app.orchestrator import handle_user_message, save_state, OrchestratorState
...
async def test_coder_create_new_website() -> None:
    ...
    # ---- Callbacks expected by orchestrator ----
    ...
    async def stream_to_user_callback(stream_or_text):
        """
    ...
    # ---- Run orchestrator (THIS is the TODO) ----
    ...
    await run_evals(case_dir, streamed_text)
